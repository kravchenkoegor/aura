...
def upgrade():
    ...
    sa.Column('id', sa.Uuid(), nullable=False),
    sa.Column('model_used', sa.Text(), nullable=False, comment='The AI model used for generation (e.g., Gemini 2.5 Pro, Flash)'),
    ...
    sa.Column('name', sa.String(length=64), nullable=False, comment='e.g., "English", "Spanish"'),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('is_primary', sa.Boolean(), nullable=False, comment='To mark the main image of a carousel'),
    sa.Column('created_at', sa.TIMESTAMP(timezone=True), nullable=False),
    ...
    sa.Column('created_at', sa.TIMESTAMP(timezone=True), nullable=False),
    sa.ForeignKeyConstraint(['generation_id'], ['generation_metadata.id'], ondelete='RESTRICT'),
    ...
    sa.Column('id', sa.Uuid(), nullable=False),
    sa.Column('type', sa.Enum('llm_generate', 'instagram_download', name='tasktype'), nullable=False),
